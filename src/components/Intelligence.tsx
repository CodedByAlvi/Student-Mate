  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-display text-3xl sm:text-5xl font-bold tracking-tight">Study Insights</h2>
          <p className="text-sm sm:text-base text-stone-500 dark:text-stone-400">AI-powered academic guidance</p>
        </div>
        <div className="flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-brand-100 text-brand-600 dark:bg-brand-900/30">
      ...
      <div className={cn(
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="h-80 w-full rounded-2xl bg-white p-4 shadow-sm dark:bg-stone-900">
          ...
          <section className="rounded-3xl bg-stone-900 p-8 text-white dark:bg-brand-900/40 shadow-xl">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500">
                <BrainCircuit className="h-7 w-7" />
              </div>
              <h3 className="font-display text-xl font-bold">Smart Strategy</h3>
            </div>
            <ul className="mt-6 space-y-4">
              ...
              <li className="flex items-start gap-3 text-sm sm:text-base text-stone-300">
                <div className="mt-2 h-2 w-2 shrink-0 rounded-full bg-brand-500" />
      ...
      <button 
        ...
        className={cn(
          "fixed z-40 flex h-14 w-14 items-center justify-center rounded-full bg-brand-600 text-white shadow-xl shadow-brand-600/30 transition-transform active:scale-90",
          isTablet || isDesktop ? "bottom-10 right-10 h-16 w-16" : "bottom-32 right-6"
        )}
      >
