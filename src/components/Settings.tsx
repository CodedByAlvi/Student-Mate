  ...
  return (
    <div className="space-y-8 px-6 pb-20">
      <header>
        ...
        <p className="text-sm text-stone-500">Personalize your study space</p>
      </header>
      ...
      <div className="space-y-6">
        <section className="space-y-4">
          ...
          <div className="rounded-3xl border border-stone-200 bg-white p-6 space-y-6 dark:border-stone-800 dark:bg-stone-900">
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-3xl border border-stone-200 bg-white p-6 space-y-4 dark:border-stone-800 dark:bg-stone-900">
            {fonts.map((f) => (
              <button
                key={f.id}
